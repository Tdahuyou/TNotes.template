---
id: e3db9066-6ea1-4119-8af9-6ee47b5a45b7
---

> 本文是 `@tnotesjs/core` + VitePress + submodule 时期的设计备忘。新知识库请用 Desk + `@tnotesjs/kb` + `@tnotesjs/ssg`。core 冻结在 0.8.0，不再作为新库依赖。

## 1. 本节内容

- TNotes.core 方案设计文档（归档）
